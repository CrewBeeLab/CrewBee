...
- [ ] Map Team-oriented core contracts to OpenCode runtime shape
- [ ] Implement event stream ingestion
- [ ] Add Team selection and mode routing

## Milestone 3: Manager UX

- [ ] Add CLI for Team install/list/validate
- [ ] Add run replay and comparison report
- [ ] Add budget and prompt assembly analysis

## Milestone 4: V1 Team system
