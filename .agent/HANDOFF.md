...
- Added `teams/template/` as the reusable Team template directory.
- Moved defined Team assets into `teams/`.
...
1. Implement a loader that reads `teams/` and `teams/template/`-style assets into the typed `AgentTeamDefinition` model.
